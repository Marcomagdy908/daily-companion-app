...
class _WelcomeTutorialDialogState extends State<WelcomeTutorialDialog> {
  ...
  final List<_TutorialSlide> _slides = const [
    _TutorialSlide(
      ...
      subtitle: 'الاسرات الجامعية — أسقفية الشباب ✝️',
      description:
          'تطبيق «رفيق يومي» صُنِع بِمَحَبَّة وإعداد أسرة مار أفرام السرياني لخدمة شباب الأسرات الجامعية (أسقفية الشباب).\nالمنهج الروحي يتناول مادة شبابيات مهرجان مسرتي فيك 2026 - مهرجان الاسرات الجامعية.',
    ),
    _TutorialSlide(
      icon: '🌅',
